...
function validate(options) {
	...
	req.end(function(res){
		...
		var deprecation = 'This interface to HTML5 document checking is deprecated.';
		if (res.text.messages && res.text.messages[0] && res.text.messages[0].message === deprecation) {
			res.text.messages.shift();
		}
